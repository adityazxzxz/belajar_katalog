...
public class ImageFavoriteWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.neverstop_sharing.katalogmovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.neverstop_sharing.katalogmovie.EXTRA_ITEM";
